...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="Button2" runat="server" Text="Button" BackColor="Blue" ForeColor="White" OnClick="Button2_Click" />
           ...
           <%-- <asp:RadioButton ID="RadioButton3" runat="server"  />男
            <asp:RadioButton ID="RadioButton4" runat="server"  />女--%>
