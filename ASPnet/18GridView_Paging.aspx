...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style>
        ...
        #GridView1 tr:last-child table a[href*="First"] { /** 用來模糊查詢*/
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AllowPaging="true" PageSize="1">
                <PagerSettings Mode="NumericFirstLast" PageButtonCount="3" NextPageText="8" PreviousPageText="7" FirstPageText="9" LastPageText=":" />
                
                <%--PageButtonCount="3" 最多顯示三個button--%>
