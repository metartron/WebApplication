<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HW5.aspx.cs" Inherits="Homework.HW5" %>
       ...
       <div>
           <asp:ValidationSummary ID="ValidationSummary1" runat="server" Font-Size="10pt" ForeColor="Red" DisplayMode="BulletList" ShowMessageBox="true"/>
            ...
            <asp:TextBox ID="txtPwd2" runat="server" TextMode="Password" placeholder="請再輸入一次密碼"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td >
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Text="(必填)" ErrorMessage="身分證為必填欄位" ForeColor="Red" Font-Size="10pt" ControlToValidate="txtID" Display="Dynamic" ></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td >
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" Text="(必填)" ErrorMessage="生日為必填欄位" ForeColor="Red" Font-Size="10pt" ControlToValidate="txtBirthday" Display="Dynamic"></asp:RequiredFieldValidator>
                        ...
                        <asp:RangeValidator ID="ranForBirthday" runat="server" ErrorMessage="(超出範圍)" ForeColor="Red" Font-Size="10pt"  MinimumValue="1912/1/1" ControlToValidate="txtBirthday"></asp:RangeValidator>
                    </td>
                </tr>
                <tr>
                    <td >E-mail：</td>
            ...
            <asp:DropDownList ID="ddlEduLevel" runat="server">
                        ...
                        <asp:CompareValidator ID="CompareValidator3" runat="server" Text="(必填)" ErrorMessage="請選擇學歷" ForeColor="Red" Font-Size="10pt" ControlToValidate="ddlEduLevel" Operator="NotEqual" ValueToCompare="請選擇"></asp:CompareValidator>
                ...
                <tr>
                    ...
                    <td  >
                        ...
                        <asp:ListBox ID="ltbInterestFinal" runat="server" Width="100" Height="150">
                                    ...
                                    <asp:CustomValidator ID="CustomValidator2" ForeColor="Red" Font-Size="10pt" runat="server" OnServerValidate="CustomValidator2_ServerValidate"  Text="(必填)" ErrorMessage="至少要選三各興趣"></asp:CustomValidator>
